...
exports.deliver = function (webroot, req, res) {
  ...
  process.nextTick(function() {
    ...
    errorCallback = errorCallback || function(statCode) {
      res.writeHead(statCode, {'Content-Type': 'text/html', 'Content-Length':32});
      res.end("<h1>HTTP " + statCode + "</h1>");
    };
    otherwiseCallback = otherwiseCallback || function(e) {
      res.writeHead(404, {'Content-Type': 'text/html', 'Content-Length':32});
